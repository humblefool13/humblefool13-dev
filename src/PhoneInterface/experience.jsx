...
import ProgressBar from "../PcInterface/ProgressBar";
    ...
    <div>
        ...
        <>
          ...
          >
            <div className="w-[90vw] h-screen m-auto flex flex-col justify-center items-center">
              ...
              />
              <p className="font-Space text-[4vw] pt-[2%] text-center w-[70%]">
                {imageSelected.desc}
              </p>
            </div>
          </div>
      ...
      <div className="backdrop-blur-[40px]">
        <div className="m-auto w-4/5">
          <div className="container flex flex-col" id="container1">
            <div className="flex flex-col mt-[2vh]">
              <h1 className="font-Oswald py-[3vw] text-[14vw] underline-offset-8 font-bold underline">
                Easy Bot
              </h1>
              <div className="pb-[3vw]">
                <ProgressBar width={"70"} height={"2"} progress={0.25} />
              </div>
              <div className="font-Rubik text-[4vw] w-[90%]">
            ...
            <div className="flex flex-row justify-center items-center">
              <div>
                <img
                  ...
                  src={Easy}
                  alt="Easy Bot Peak"
                  className="bg-[linear-gradient(_#6af50d_10%,#0f0e13_30%,#0f0e13_70%,#ffeb3b_90%_)] p-[1px] w-[90%] m-auto rounded-md my-[4vh]"
                />
              </div>
            </div>
          </div>
          <div className="container flex flex-col" id="container2">
            <div className="flex flex-col mt-[2vh]">
              <h1 className="font-Oswald py-[3vw] text-[14vw] underline-offset-8 font-bold underline decoration-[#ffeb3b] text-gradient-green">
                <a href="https://1337.group/" target="_blank" rel="noreferrer">
                  Group 1337
                </a>
              </h1>
              <div className="pb-[3vw]">
                <ProgressBar width={"70"} height={"2"} progress={0.5} />
              </div>
              <div className="font-Rubik text-[4vw] w-[90%]">
          ...
          <div className="container flex flex-col" id="container3">
            <div className="flex flex-col mt-[2vh]">
              <h1 className="font-Oswald py-[3vw] text-[14vw] underline-offset-8 font-bold underline">
                BoBotLabs
              </h1>
              <div className="pb-[3vw]">
                <ProgressBar width={"70"} height={"2"} progress={0.75} />
              </div>
              <div className="font-Rubik text-[4vw] w-[90%]">
          ...
          <div className="container flex flex-col" id="container4">
            <div className="flex flex-col mt-[2vh]">
              <h1 className="font-Oswald py-[3vw] text-[14vw] underline-offset-8 font-bold underline decoration-[#ffeb3b] text-gradient-green">
                <a
              ...
              <div className="pb-[3vw]">
                <ProgressBar width={"70"} height={"2"} progress={1} />
              </div>
              <div className="font-Rubik text-[4vw] w-[90%]">
            ...
            <div className="flex flex-row justify-center items-center mb-[8vh]">
              <div>
                <img
                  onClick={() =>
                    setImageSelected({
