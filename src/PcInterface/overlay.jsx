...
const OverlayComponent = () => {
  return (
    <Scroll html className="w-full">
      <div className="absolute w-2/5 font-Rubik left-[55%] top-[150vh] p-[10px] bg-[#ffffff0d] rounded-2xl backdrop-blur-[5px] border-[1px] border-solid border-[#ffffff4d] text-[25px]">
        <h1 className="py-[10px] text-[35px]">Meet Bo!</h1>
      ...
      <div className="bg-[#ffffff0d] rounded-2xl backdrop-blur-[5px] border-[1px] border-solid border-[#ffffff4d] top-[260vh] absolute w-2/5 p-[10px] left-[5%] font-Rubik  text-[25px]">
        <h1 className="py-[10px] text-[35px]">Current</h1>
      ...
      <div className="bg-[#ffffff0d] rounded-2xl backdrop-blur-[5px] border-[1px] border-solid border-[#ffffff4d] top-[355vh] absolute w-2/5 p-[10px] left-[55%] font-Rubik  text-[25px]">
        <h1 className="py-[10px] text-[35px]">Future</h1>
