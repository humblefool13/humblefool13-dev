...
const Topbar = () => {
  ...
  return (
    <>
      <div className="sticky header-component-pc font-Yeseva hidden md:inline lg:text-[20px] xl:text-[25px] md:text-[18px] 2xl:text-[30px] py-[10px] z-[100] bg-[#0f0e13] w-screen">
